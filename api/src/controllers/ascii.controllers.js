...
const { avatarifyText } = require('../services/avatarifyText.service');
...
const asciifyAvatarAndCloudinaryUpload = async (req, res) => {
  ...
  try {
    ...
    // CONVERTIR STRING DE ASCII EN UNA IMAGEN ASCII (BASE64)
    const asciiImage = await avatarifyText(asciiText, color, bg_color, definition);
...
module.exports = {
  ...
  asciifyAvatarAndCloudinaryUpload,
  asciiTest
}
